          ...
          children: [
            ...
            Padding(
              ...
              child: Calendar(
                ...
                selectedDate: selectedDatePrevious ?? DateTime.now(),
              ),
            ),
                  ...
                  GestureDetector(
                    onTap: () async {
                      final result = await showModalBottomSheet(
                        ...
                        builder:
                            (context) =>
                        //AddTaskBottomSheet(groupId: widget.group.id, selectedDateOnCalendar: selectedDate),
                        AddTaskModal(groupId: widget.group.id, selectedDateOnCalendar: selectedDate),
                      );
